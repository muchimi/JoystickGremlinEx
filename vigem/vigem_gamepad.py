...
class VX360Gamepad(VGamepad):
    ...
    def left_joystick_float_x(self, value_float):
        """
        Sets the values of the X axis for the right joystick
    ...
    def left_joystick_float_y(self, value_float):
        """
        Sets the values of the X axis for the right joystick
    ...
    def right_joystick_float_y(self, value_float):
        """
        Sets the values of the X axis for the right joystick
