...
class MidiDeviceTabWidget(gremlin.ui.ui_common.QSplitTabWidget):
    ...
    def __init__(
        ...
        widget, _ = gremlin.ui.ui_common.getHContainer(["MIDI Inputs", "||", lock_widget])
    ...
    def _clear_inputs_cb(self):
        ...
        # widget = gremlin.ui.joystick_device.InputItemMappingWidget(object_name="MIDI Blank InputConfigItem (clear inputs)")     
