...
from .ui_generic_slider import CC_SLIDER, SC_GROOVE, SC_HANDLE, SC_NONE, _GenericSlider
from .ui_range_style import (
...
class _GenericRangeSlider(_GenericSlider):
    ...
    def _fireHandleClicked(self):
        self.handleRightClicked.emit(self._pressedIndex)
