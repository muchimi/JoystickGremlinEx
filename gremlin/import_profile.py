...
class ImportProfileDialog(gremlin.ui.ui_common.QRememberDialog):
    ...
    def _create_ui(self):
        ...
        warning_widget = gremlin.ui.ui_common.QIconLabel("ei.refresh",use_qta=True,icon_color=QtGui.QColor("orange"),text="This function is experimental and still in development, and not necessary feature complete", use_wrap=False)
