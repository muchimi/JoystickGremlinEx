...
a = Analysis(
    ...
    datas=added_files,
    hiddenimports=['mido.backends.rtmidi','lxml','pyttsx3','hid',"windows_event_hook","psygnal","graphviz","numpy","scipy","scipy._cyutility","sounddevice","soundfile","pyrubberband"],
    hookspath=None,
    runtime_hooks=None,
    excludes=["torch",
        "torchvision",
