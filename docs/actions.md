...
| Map to Stream Deck | Select a connected Stream Deck and run a function (Change Page first) via the plugin bridge | Use with the [Stream Deck plugin bridge](streamdeck.md) |
