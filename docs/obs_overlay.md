...
| Image | Custom picture; PNG/WebP/GIF keep transparency. Paste a Windows Snipping Tool screenshot with Ctrl+V, right-click **Paste image**, or inspector **Paste** |
| Stream Deck | Live preview of a connected Elgato Stream Deck |

## Bindings

Each widget (except labels, shapes, images, Stream Deck widgets, **Mouse** widgets, **Temporal graph** widgets, **Bar graph** widgets, **Counter** widgets, and **Keyboard / Mouse** widgets) can bind to:
