...
class VJoyWidget(gremlin.ui.input_item.AbstractActionWidget):
    ...
    def update_steps(self):
        ...
        if steps > 0:
            ...
            if (
                self.action_data.target_step_index not in self.action_data.target_step_list
            ):
...
class VjoyRemap(gremlin.base_profile.AbstractAction):
    ...
    def icon(self):
        ...
        icon_path = (
            f"{dark_stub}icon_{input_string}_{self.vjoy_input_id:03d}.png"
            if input_string
            else "joystick.png"
        )
    ...
    def _generate_xml(self):
        ...
        match self.action_mode:
            ...
            case VjoyAction.VJoyMergeAxis:
                ...
                node.set(
                    "merge_input_type",
                    gremlin.input_types.InputType.to_string(self.merge_input_type),
                )
