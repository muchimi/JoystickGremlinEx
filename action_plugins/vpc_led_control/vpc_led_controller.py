...
def set_color(vid, pid, command, hex_color, filepath = None):
    if filepath is None:
        filepath = os.path.join(os.path.dirname(os.path.realpath(__file__)), "VPC_LED_Control.exe")
...
if __name__ == "__main__":
    filepath = os.path.join("VPC_LED_Control.exe")
    # default is cmd 21
    send = set_color("3344", "812F", "21", "000000")
    print(send)