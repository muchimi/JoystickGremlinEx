...
class ControlWidget(gremlin.input_item.AbstractActionWidget):
    ...
    def _create_ui(self):
        ...
        self.action_widget = gremlin.ui.ui_common.QDataComboBox(value=self.action_data.action, source=items, tooltip="Control action")
    ...
    def _update_device_list(self):
        # device list
        device_list: list[gremlin.base_profile.ProfileDeviceNode] = self.profile.get_ordered_device_list()
    ...
    def _update_input_list(self):
        ...
        device_profile = self.profile.get_device_modes(device.device_guid, device.type, device.name)
        use_prefix = False
