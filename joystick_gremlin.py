    ...
    def _add_tab(self, device_guid, tab_type, index = None) -> int: 
        ...
        if device_name == "Controller (XBOX 360 For Windows)":
            ...
            if not widget:
                ...
                device_profile,
                self.current_mode,
                object_name= f"XBOX DEVICE: {device_name}"
                )
        ...
        self.ui.devices.setTabData(position, TabData(device_guid, tab_type, device))
                ...
                if device_name:
                    ...
                    if not widget:
                        widget = gremlin.ui.joystick_device.JoystickDeviceTabWidget(
                            ...
                            device_profile,
                            self.current_mode,
                            object_name= f"JOYSTICK DEVICE: {device_name}"
                        )
                ...
                if device_name:
                    ...
                    if not widget:
                        widget = gremlin.ui.joystick_device.JoystickDeviceTabWidget(
                            ...
                            device_profile,
                            self.current_mode,
                            object_name= f"VJOY DEVICE: {device_name}"
                        )
